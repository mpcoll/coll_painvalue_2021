...
# Paths
###################################################################
name = 'shocklevel' # Analysis name
basepath = '/data'
model_dir = opj(basepath, 'derivatives/glms/model_shocks')
outpath =  opj(basepath, 'derivatives/mvpa/shock_intensity_level')
...
map_unthr = painmapfdr = load_img(opj(basepath, 'derivatives/mvpa/shock_intensity_level',
                           'anticipation_univariate_unthresholded.nii'))
map_001 = painmapfdr = load_img(opj(basepath, 'derivatives/mvpa/shock_intensity_level',
                           'anticipation_univariate_unc001.nii'))
map_fwe = painmapfdr = load_img(opj(basepath, 'derivatives/mvpa/shock_intensity_level',
...
plot_multi_supp(map_unthr,
                ...
                cmap_label='T-value',
                name3='FWE',
                title='Parametric effect of shock intensity',
